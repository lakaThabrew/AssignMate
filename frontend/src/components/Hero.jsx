...
export default function Hero() {
  ...
  return (
    <section className="hero-section" style={{ padding: 0, height: '400px', position: 'relative', overflow: 'hidden', borderRadius: '24px', marginBottom: '3rem' }}>
      <canvas ref={canvasRef} style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', zIndex: 0 }} />
      <div style={{ position: 'relative', zIndex: 1, padding: '4rem 2rem', textAlign: 'center' }}>
