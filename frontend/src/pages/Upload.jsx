    ...
    try {
      ...
      setError(
        err.response?.data?.error ||
          "Error analyzing assignment. Please try again.",
      );
    } finally {
      setLoading(false);
    }
    ...
    <div>
      <div className="header-light">
        <h1 style={{ color: "var(--color-dark)" }}>
          Start New <span className="header-accent">Evaluation</span>
        </h1>
        <p style={{ marginTop: "10px", color: "#666" }}>
          Upload an assignment and select a rubric for AI analysis.
        </p>
      </div>
        ...
        <form onSubmit={handleSubmit}>
            ...
            >
              ...
              {assignment ? (
                <>
                  ...
                  <div style={{ color: "#666" }}>
                    {(assignment.size / 1024 / 1024).toFixed(2)} MB
                  </div>
                </>
              ) : (
                <>
          ...
          <div className="form-group" style={{ marginBottom: "2rem" }}>
            ...
            >
              ...
              <option value="Post-Graduate/Masters/PhD">
